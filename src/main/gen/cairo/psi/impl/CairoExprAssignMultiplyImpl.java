...
public class CairoExprAssignMultiplyImpl extends CairoExprImpl implements CairoExprAssignMultiply {

  public CairoExprAssignMultiplyImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprAssignMultiply(this);
  }
