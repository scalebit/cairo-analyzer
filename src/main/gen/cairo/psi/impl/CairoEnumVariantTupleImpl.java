...
public class CairoEnumVariantTupleImpl extends CairoEnumVariantImpl implements CairoEnumVariantTuple {

  public CairoEnumVariantTupleImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitEnumVariantTuple(this);
  }
