...
public class CairoExprBitwiseOrImpl extends CairoExprImpl implements CairoExprBitwiseOr {

  public CairoExprBitwiseOrImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprBitwiseOr(this);
  }
