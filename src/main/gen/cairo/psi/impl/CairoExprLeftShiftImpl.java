...
public class CairoExprLeftShiftImpl extends CairoExprImpl implements CairoExprLeftShift {

  public CairoExprLeftShiftImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprLeftShift(this);
  }
