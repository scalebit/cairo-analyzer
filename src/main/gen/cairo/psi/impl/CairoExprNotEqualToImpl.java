...
public class CairoExprNotEqualToImpl extends CairoExprImpl implements CairoExprNotEqualTo {

  public CairoExprNotEqualToImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprNotEqualTo(this);
  }
