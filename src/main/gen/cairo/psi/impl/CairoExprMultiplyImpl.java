...
public class CairoExprMultiplyImpl extends CairoExprImpl implements CairoExprMultiply {

  public CairoExprMultiplyImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprMultiply(this);
  }
