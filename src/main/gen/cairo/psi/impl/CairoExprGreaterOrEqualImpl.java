...
public class CairoExprGreaterOrEqualImpl extends CairoExprImpl implements CairoExprGreaterOrEqual {

  public CairoExprGreaterOrEqualImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprGreaterOrEqual(this);
  }
