...
public class CairoExprDerefImpl extends CairoExprImpl implements CairoExprDeref {

  public CairoExprDerefImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprDeref(this);
  }
