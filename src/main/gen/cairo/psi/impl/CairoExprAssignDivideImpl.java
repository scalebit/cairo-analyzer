...
public class CairoExprAssignDivideImpl extends CairoExprImpl implements CairoExprAssignDivide {

  public CairoExprAssignDivideImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprAssignDivide(this);
  }
