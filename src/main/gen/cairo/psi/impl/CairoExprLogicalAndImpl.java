...
public class CairoExprLogicalAndImpl extends CairoExprImpl implements CairoExprLogicalAnd {

  public CairoExprLogicalAndImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprLogicalAnd(this);
  }
