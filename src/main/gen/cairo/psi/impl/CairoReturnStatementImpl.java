...
public class CairoReturnStatementImpl extends ASTWrapperPsiElement implements CairoReturnStatement {

  public CairoReturnStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
