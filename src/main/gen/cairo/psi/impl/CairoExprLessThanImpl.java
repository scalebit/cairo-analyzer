...
public class CairoExprLessThanImpl extends CairoExprImpl implements CairoExprLessThan {

  public CairoExprLessThanImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprLessThan(this);
  }
