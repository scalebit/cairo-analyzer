...
public class CairoPrototypeVariableArgImpl extends ASTWrapperPsiElement implements CairoPrototypeVariableArg {

  public CairoPrototypeVariableArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitPrototypeVariableArg(this);
  }
