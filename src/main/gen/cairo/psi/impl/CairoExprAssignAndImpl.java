...
public class CairoExprAssignAndImpl extends CairoExprImpl implements CairoExprAssignAnd {

  public CairoExprAssignAndImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprAssignAnd(this);
  }
