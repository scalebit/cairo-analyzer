...
public class CairoExprFieldImpl extends CairoExprImpl implements CairoExprField {

  public CairoExprFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprField(this);
  }
