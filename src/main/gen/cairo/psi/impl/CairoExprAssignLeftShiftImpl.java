...
public class CairoExprAssignLeftShiftImpl extends CairoExprImpl implements CairoExprAssignLeftShift {

  public CairoExprAssignLeftShiftImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprAssignLeftShift(this);
  }
