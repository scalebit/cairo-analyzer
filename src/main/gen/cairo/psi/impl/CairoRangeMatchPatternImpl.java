...
public class CairoRangeMatchPatternImpl extends CairoMatchPatternImpl implements CairoRangeMatchPattern {

  public CairoRangeMatchPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitRangeMatchPattern(this);
  }
