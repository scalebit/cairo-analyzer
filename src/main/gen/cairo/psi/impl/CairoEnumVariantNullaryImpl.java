...
public class CairoEnumVariantNullaryImpl extends CairoEnumVariantImpl implements CairoEnumVariantNullary {

  public CairoEnumVariantNullaryImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitEnumVariantNullary(this);
  }
