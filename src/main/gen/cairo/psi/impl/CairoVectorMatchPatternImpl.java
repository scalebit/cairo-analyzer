...
public class CairoVectorMatchPatternImpl extends CairoMatchPatternImpl implements CairoVectorMatchPattern {

  public CairoVectorMatchPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitVectorMatchPattern(this);
  }
