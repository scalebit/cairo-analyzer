...
public class CairoExprAssignIncrementImpl extends CairoExprImpl implements CairoExprAssignIncrement {

  public CairoExprAssignIncrementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprAssignIncrement(this);
  }
