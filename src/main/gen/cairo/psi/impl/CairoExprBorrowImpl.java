...
public class CairoExprBorrowImpl extends CairoExprImpl implements CairoExprBorrow {

  public CairoExprBorrowImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprBorrow(this);
  }
