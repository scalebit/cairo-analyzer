...
public class CairoLetArgsImpl extends ASTWrapperPsiElement implements CairoLetArgs {

  public CairoLetArgsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitLetArgs(this);
  }
