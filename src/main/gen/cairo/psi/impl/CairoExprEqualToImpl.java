...
public class CairoExprEqualToImpl extends CairoExprImpl implements CairoExprEqualTo {

  public CairoExprEqualToImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprEqualTo(this);
  }
