...
public class CairoClosureSugarImpl extends ASTWrapperPsiElement implements CairoClosureSugar {

  public CairoClosureSugarImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitClosureSugar(this);
  }
