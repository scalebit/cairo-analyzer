...
public class CairoPrototypeSelfArgImpl extends ASTWrapperPsiElement implements CairoPrototypeSelfArg {

  public CairoPrototypeSelfArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitPrototypeSelfArg(this);
  }
