...
public class CairoExprTupleBodyImpl extends CairoExprImpl implements CairoExprTupleBody {

  public CairoExprTupleBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprTupleBody(this);
  }
