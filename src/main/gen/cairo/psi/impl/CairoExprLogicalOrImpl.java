...
public class CairoExprLogicalOrImpl extends CairoExprImpl implements CairoExprLogicalOr {

  public CairoExprLogicalOrImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprLogicalOr(this);
  }
