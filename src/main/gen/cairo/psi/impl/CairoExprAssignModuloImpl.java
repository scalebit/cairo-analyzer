...
public class CairoExprAssignModuloImpl extends CairoExprImpl implements CairoExprAssignModulo {

  public CairoExprAssignModuloImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprAssignModulo(this);
  }
