...
public class CairoBlockUnsafeImpl extends CairoExprBlockImpl implements CairoBlockUnsafe {

  public CairoBlockUnsafeImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitBlockUnsafe(this);
  }
