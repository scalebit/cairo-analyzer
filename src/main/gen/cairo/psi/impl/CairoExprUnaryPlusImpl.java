...
public class CairoExprUnaryPlusImpl extends CairoExprImpl implements CairoExprUnaryPlus {

  public CairoExprUnaryPlusImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprUnaryPlus(this);
  }
