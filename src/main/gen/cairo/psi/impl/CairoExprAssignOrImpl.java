...
public class CairoExprAssignOrImpl extends CairoExprImpl implements CairoExprAssignOr {

  public CairoExprAssignOrImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprAssignOr(this);
  }
