...
public class CairoTraitFunctionDeclarationImpl extends ASTWrapperPsiElement implements CairoTraitFunctionDeclaration {

  public CairoTraitFunctionDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitTraitFunctionDeclaration(this);
  }
  ...
  @Override
  @Nullable
  public CairoPrototypeArgs getPrototypeArgs() {
    return findChildByClass(CairoPrototypeArgs.class);
  }
