...
public class CairoStructDefaultImpl extends ASTWrapperPsiElement implements CairoStructDefault {

  public CairoStructDefaultImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitStructDefault(this);
  }
