...
public class CairoMacroBraceImpl extends ASTWrapperPsiElement implements CairoMacroBrace {

  public CairoMacroBraceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitMacroBrace(this);
  }
