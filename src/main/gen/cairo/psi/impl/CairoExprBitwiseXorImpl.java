...
public class CairoExprBitwiseXorImpl extends CairoExprImpl implements CairoExprBitwiseXor {

  public CairoExprBitwiseXorImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprBitwiseXor(this);
  }
