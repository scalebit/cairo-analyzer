...
public class CairoExternBlockImpl extends ASTWrapperPsiElement implements CairoExternBlock {

  public CairoExternBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CairoExternVariable> getExternVariableList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CairoExternVariable.class);
  }
