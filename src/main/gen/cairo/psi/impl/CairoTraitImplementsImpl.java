...
public class CairoTraitImplementsImpl extends ASTWrapperPsiElement implements CairoTraitImplements {

  public CairoTraitImplementsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitTraitImplements(this);
  }
