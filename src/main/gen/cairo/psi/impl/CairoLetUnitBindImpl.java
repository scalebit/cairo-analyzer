...
public class CairoLetUnitBindImpl extends CairoLetBindImpl implements CairoLetUnitBind {

  public CairoLetUnitBindImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitLetUnitBind(this);
  }
