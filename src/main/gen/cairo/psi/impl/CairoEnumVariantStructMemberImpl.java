...
public class CairoEnumVariantStructMemberImpl extends CairoEnumVariantImpl implements CairoEnumVariantStructMember {

  public CairoEnumVariantStructMemberImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitEnumVariantStructMember(this);
  }
