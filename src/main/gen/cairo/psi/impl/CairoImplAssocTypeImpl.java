...
public class CairoImplAssocTypeImpl extends ASTWrapperPsiElement implements CairoImplAssocType {

  public CairoImplAssocTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitImplAssocType(this);
  }
