...
public class CairoExprAssignDecrementImpl extends CairoExprImpl implements CairoExprAssignDecrement {

  public CairoExprAssignDecrementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprAssignDecrement(this);
  }
