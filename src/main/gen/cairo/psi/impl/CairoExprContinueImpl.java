...
public class CairoExprContinueImpl extends CairoExprImpl implements CairoExprContinue {

  public CairoExprContinueImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprContinue(this);
  }
