...
public class CairoExprAssignNotImpl extends CairoExprImpl implements CairoExprAssignNot {

  public CairoExprAssignNotImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprAssignNot(this);
  }
