...
public class CairoExprVectorImpl extends CairoExprImpl implements CairoExprVector {

  public CairoExprVectorImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprVector(this);
  }
