...
public class CairoExprCallImpl extends CairoExprImpl implements CairoExprCall {

  public CairoExprCallImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public CairoCallParams getCallParams() {
    return findNotNullChildByClass(CairoCallParams.class);
  }
