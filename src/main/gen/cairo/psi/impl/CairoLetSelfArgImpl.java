...
public class CairoLetSelfArgImpl extends ASTWrapperPsiElement implements CairoLetSelfArg {

  public CairoLetSelfArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitLetSelfArg(this);
  }
