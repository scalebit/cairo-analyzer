...
public class CairoExprBreakImpl extends CairoExprImpl implements CairoExprBreak {

  public CairoExprBreakImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprBreak(this);
  }
