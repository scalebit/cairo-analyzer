...
public class CairoExprLessOrEqualImpl extends CairoExprImpl implements CairoExprLessOrEqual {

  public CairoExprLessOrEqualImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprLessOrEqual(this);
  }
