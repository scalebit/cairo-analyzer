...
public class CairoPrototypeArgsImpl extends ASTWrapperPsiElement implements CairoPrototypeArgs {

  public CairoPrototypeArgsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitPrototypeArgs(this);
  }
