...
public class CairoExprUnaryMinusImpl extends CairoExprImpl implements CairoExprUnaryMinus {

  public CairoExprUnaryMinusImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprUnaryMinus(this);
  }
