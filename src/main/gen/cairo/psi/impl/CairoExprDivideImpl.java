...
public class CairoExprDivideImpl extends CairoExprImpl implements CairoExprDivide {

  public CairoExprDivideImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprDivide(this);
  }
