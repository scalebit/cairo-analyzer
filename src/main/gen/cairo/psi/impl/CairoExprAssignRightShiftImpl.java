...
public class CairoExprAssignRightShiftImpl extends CairoExprImpl implements CairoExprAssignRightShift {

  public CairoExprAssignRightShiftImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprAssignRightShift(this);
  }
