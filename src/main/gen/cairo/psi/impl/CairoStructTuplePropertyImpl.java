...
public class CairoStructTuplePropertyImpl extends ASTWrapperPsiElement implements CairoStructTupleProperty {

  public CairoStructTuplePropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitStructTupleProperty(this);
  }
