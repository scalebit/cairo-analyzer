...
public class CairoExprGreaterThanImpl extends CairoExprImpl implements CairoExprGreaterThan {

  public CairoExprGreaterThanImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprGreaterThan(this);
  }
