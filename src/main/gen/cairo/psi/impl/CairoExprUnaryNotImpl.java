...
public class CairoExprUnaryNotImpl extends CairoExprImpl implements CairoExprUnaryNot {

  public CairoExprUnaryNotImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitExprUnaryNot(this);
  }
