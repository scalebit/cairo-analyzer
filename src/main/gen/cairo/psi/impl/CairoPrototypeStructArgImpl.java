...
public class CairoPrototypeStructArgImpl extends ASTWrapperPsiElement implements CairoPrototypeStructArg {

  public CairoPrototypeStructArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitPrototypeStructArg(this);
  }
