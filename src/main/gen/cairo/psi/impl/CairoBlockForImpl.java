...
public class CairoBlockForImpl extends CairoExprBlockImpl implements CairoBlockFor {

  public CairoBlockForImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CairoVisitor visitor) {
    visitor.visitBlockFor(this);
  }
